...
translate(language){
  if(language == "arabic"){
   ...
   document.getElementById("title").innerHTML = "ملابس اطفال";
   ...
   document.getElementById("accessories").innerHTML = "أكسيسورات";
   document.getElementById("logOut").innerHTML = "تسجيل الخروج";
   ...
   document.getElementById("item3").innerHTML = "اكسيسورات";
   ...
   document.getElementById("title").innerHTML = "Kids clothing";
